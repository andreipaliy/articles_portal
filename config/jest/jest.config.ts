...
export default {
    ...
    // The directory where Jest should store its cached dependency information cacheDirectory: "/private/var/folders/vm/rzm0nnrj6tdcxkn9kf5p6lnr0000gn/T/jest_dx",
